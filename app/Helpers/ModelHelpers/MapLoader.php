...
use App\Helpers\Database\Map as MapRecord;
use App\Helpers\Database\Tile as TileRecord;
use App\Helpers\Database\Cell as CellRecord;
use App\Helpers\Database\TileType;

/**
 * Used to query the database with enough information to constuct a view of a game map.
 */
class MapLoader
{
